        ...
        <>
            ...
            <div className="relative overflow-hidden max-w-7xl w-full min-h-screen mx-auto">
                <div className='flex flex-col items-center gap-5'>
                    <h1 className="mt-5 text-center font-medium text-4xl xs:text-5xl lg:text-6xl max-w-prose text-text-heading">Smart <span className="font-semibold text-primary-dark">HealthCare</span><br />Management</h1>
