...
const SearchBar = ({ onSelectPatient }) => {
    ...
    return (
        <div className="relative border-b border-slate-200 pb-4">
            ...
            <input
                onKeyDown={handleKeyDown} value={search} onChange={(e) => searchData(e.target.value)} type="text" placeholder="ID or Patients Name" className="min-w-full w-full pl-10 pr-50 outline-none bg-slate-50 px-4 py-2 border border-slate-200 mx-auto rounded-lg focus:ring-2 focus:ring-blue-500/20" />
