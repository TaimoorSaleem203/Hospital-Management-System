  ...
  return (
    <nav className={`px-8 sm:px-12 py-8 font-poppins`}>
      <div className="max-w-7xl mx-auto flex gap-5 items-center sm:justify-center">
        <Link to="/" className="text-[28px] md:text-[30px] cursor-pointer text-primary-dark font-medium">Medi<span className="font-semibold">Core</span></Link>
        ...
        {open && 
          (
            <div className="flex md:hidden flex-col gap-3 drop-shadow-md absolute right-0 -translate-x-8 translate-y-16 transition-transform duration-300 ease-in-out z-10 w-32 h-28 rounded-xl bg-primary">
