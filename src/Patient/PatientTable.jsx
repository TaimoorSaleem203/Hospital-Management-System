import DoctorProf from "../assets/DoctorProf.png"
                ...
                <table className="w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr className="border-b text-center border-[#d7d9dd] hover:bg-slate-100 cursor-pointer">
                            <td><img src={DoctorProf} className="max-w-[80px]" alt="" /></td>
                            <td className='font-semibold text-slate-700 leading-tight'>Dr Sarah Wilson <br /><span className="text-text-body text-sm font-medium">Cardiologist</span></td>
