...
const DoctorPanel = () => {
    ...
    const menuItems = [
        ...
        { name: "Appointments", link: "/doctor/appointment", icon: "ri-calendar-event-line", children: [{ title: "Registration Form", path: "/doctor/appointment/form", icon: "ri-user-add-line" }, { title: "Patient List", path: "/doctor/appointment/list", icon: "ri-file-list-line" }] },
    ]
    ...
    return (
        <aside className={`fixed inset-0 z-20 max-w-[1080px] xl:max-w-7xl p-5 font-poppins items-start flex flex-col min-h-screen bg-gradient-to-b to-bg-primary from-[#0FB9B1] to-[#009E9A] lg:w-[280px] xl:w-[300px]`}>
            ...
            <div className="p-2 mt-10 text-xl w-full mx-auto flex flex-col gap-4">
                {menuItems.map((items) => {
                    return (
                        <>
