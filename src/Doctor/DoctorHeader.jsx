...
const DoctorHeader = () => {
    return (
        <div className="relative ml-auto max-w-[1050px] sm:max-w-[1300px] min-h-[82px] bg-white flex justify-between items-center px-10 border-b border-[#d7d9dd]">
            ...
            <div className="flex items-center gap-3">
                ...
                {/* <img src={PatientImg} className="max-w-[50px] mx-auto w-full cursor-pointer" alt="patientImg" /> */}
            </div>
        </div>
    )
}
