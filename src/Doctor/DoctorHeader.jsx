...
const DoctorHeader = () => {
    return (
        <header className='fixed z-10 top-0 left-0 w-full bg-white border-b border-[#d7d9dd]'>
            <div className="w-full max-w-[1080px] xl:max-w-7xl ml-auto min-h-[82px] flex justify-between items-center px-4 md:px-6 lg:px-10">
                ...
                <div className="relative block">
                    ...
                    <span className="absolute animate-ping -z-0 right-[20px] bg-red-600 w-[10px] h-[10px] rounded-full"></span>
                </div>
